...
| Basic Pages                                                                               | Authentication Pages in 2 Variants + Ready to use pages like User Profile, accounts Settings,FAQ, Help Center, Pricing, Misc etc. |
...
1. In order to raise the GitHub issue, you must have a github accounts. [Raise a Issue](https://github.com/themeselection/sneat-html-admin-template-free/issues)
